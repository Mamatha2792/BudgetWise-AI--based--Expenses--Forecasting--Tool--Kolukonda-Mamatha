...
Launch the application (One-click start):
...
Select your desired prediction horizon (1-30 days)
Choose confidence level for uncertainty bands
Click "Generate Forecast" to create predictions
Explore the interactive chart with hover details
Comparing Models
Visit the � Model Comparison page
Review the performance ranking table
Examine accuracy metrics (lower MAPE = better)
Use the interactive charts to visualize performance differences
Understand which models work best for your spending patterns
Exploring Insights
Go to the 💡 AI Insights page
Review automated pattern analysis
Read personalized recommendations
Understand spending behavior trends
